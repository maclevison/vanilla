...
Vanilla is PDM's design-system skill. Activate it and the interfaces you build
belong to the same visual family — recognizably PDM — while each product keeps
