...
3. **Soul** — does the brief's signature actually exist and do work? Or could this be any PDM product (convergence)?
...
- **G · Soul / uniqueness** — read the brief's signature; is it present and doing real work? Strip the product name: could this screen be any PDM product? If yes, the soul is missing.
